    ...
    <nav class="bg-white px-4 py-4 sticky top-0 z-50 border-b shadow-sm" style="border-bottom-color: var(--border-soft);">
        <div class="max-w-[1600px] w-full mx-auto px-4 md:px-8 flex flex-wrap justify-between items-center gap-4 relative">
            ...
            <div id="dropdown-menu" class="absolute right-0 top-14 w-40 bg-white rounded-2xl shadow-2xl border border-stone-100 py-1 z-50 transform origin-top-right transition-all duration-200 scale-95 opacity-0 pointer-events-none">
                ...
                <a href="submit.html" class="block px-4 py-1.5 text-sm text-stone-600 hover:bg-[#f5ede8] hover:text-[#a37c6b] font-bold transition rounded-xl mx-2">Submit</a>
                <a href="dashboard.html" class="block px-4 py-1.5 text-sm text-stone-600 hover:bg-[#f5ede8] hover:text-[#a37c6b] font-bold transition rounded-xl mx-2">Dashboard</a>
                <a href="about.html" class="block px-4 py-1.5 text-sm text-stone-600 hover:bg-[#f5ede8] hover:text-[#a37c6b] font-bold transition rounded-xl mx-2">About</a>
                <a href="contact.html" class="block px-4 py-1.5 text-sm text-stone-600 hover:bg-[#f5ede8] hover:text-[#a37c6b] font-bold transition rounded-xl mx-2">Contact</a>
