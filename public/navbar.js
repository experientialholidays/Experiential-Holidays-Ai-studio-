...
const navbarHTML = `
    <nav class="bg-white px-4 py-4 sticky top-0 z-50 border-b shadow-sm" style="border-bottom-color: var(--border-soft);">
        <div class="max-w-[1600px] w-full mx-auto px-4 md:px-8 flex flex-wrap justify-between items-center gap-4 relative">
            ...
            <div id="dropdown-menu" class="absolute right-0 top-14 w-48 bg-white rounded-2xl shadow-2xl border border-stone-100 py-2 z-50 transform origin-top-right transition-all duration-200 scale-95 opacity-0 pointer-events-none">
                <div id="dropdown-profile" class="hidden px-4 py-2 border-b border-stone-100 mb-2 bg-stone-50/50">
                ...
                <a href="submit.html" class="block px-4 py-2 text-sm text-stone-600 hover:bg-[#f5ede8] hover:text-[#a37c6b] font-bold transition rounded-xl mx-2">Submit</a>
                <a href="dashboard.html" class="block px-4 py-2 text-sm text-stone-600 hover:bg-[#f5ede8] hover:text-[#a37c6b] font-bold transition rounded-xl mx-2">Dashboard</a>
                <a href="about.html" class="block px-4 py-2 text-sm text-stone-600 hover:bg-[#f5ede8] hover:text-[#a37c6b] font-bold transition rounded-xl mx-2">About</a>
                <a href="contact.html" class="block px-4 py-2 text-sm text-stone-600 hover:bg-[#f5ede8] hover:text-[#a37c6b] font-bold transition rounded-xl mx-2">Contact / Support</a>
                <div class="border-t border-stone-100 mt-2 pt-2">
                    <button id="login-btn-menu" class="w-[calc(100%-16px)] text-left px-4 py-2 text-sm text-stone-600 hover:bg-stone-50 hover:text-stone-900 font-bold transition rounded-xl mx-2">Sign In</button>
                    <button id="logout-btn" class="hidden w-[calc(100%-16px)] text-left px-4 py-2 text-sm text-stone-600 hover:bg-[#f5ede8] hover:text-[#a37c6b] font-bold transition rounded-xl mx-2">Logout</button>
                </div>
            </div>
        </div>
    </nav>
